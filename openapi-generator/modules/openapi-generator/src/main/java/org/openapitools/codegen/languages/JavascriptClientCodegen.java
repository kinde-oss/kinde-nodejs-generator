...
public class JavascriptClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public void preprocessOpenAPI(OpenAPI openAPI) {
        ...
        supportingFiles.add(new SupportingFile("KindeClient.mustache", createPath(sourceFolder, invokerPackage), "KindeClient.js"));
        supportingFiles.add(new SupportingFile("GrantType.mustache", createPath(sourceFolder, invokerPackage), "sdk/constant/GrantType.js"));
        supportingFiles.add(new SupportingFile("AuthorizationCode.mustache", createPath(sourceFolder, invokerPackage), "sdk/oauth2/AuthorizationCode.js"));
        supportingFiles.add(new SupportingFile("ClientCredentials.mustache", createPath(sourceFolder, invokerPackage), "sdk/oauth2/ClientCredentials.js"));
        supportingFiles.add(new SupportingFile("PKCE.mustache", createPath(sourceFolder, invokerPackage), "sdk/oauth2/PKCE.js"));
        supportingFiles.add(new SupportingFile("Utils.mustache", createPath(sourceFolder, invokerPackage), "sdk/utils/Utils.js"));

        supportingFiles.add(new SupportingFile("KindeClient_test.mustache", createPath("test", invokerPackage, "sdk"), "KindeClient.spec.js"));
        supportingFiles.add(new SupportingFile("OAuth2AuthorizationCode_test.mustache", createPath("test", invokerPackage, "sdk"), "OAuth2AuthorizationCode.spec.js"));
        supportingFiles.add(new SupportingFile("OAuth2ClientCredential_test.mustache", createPath("test", invokerPackage, "sdk"), "OAuth2ClientCredential.spec.js"));
        supportingFiles.add(new SupportingFile("OAuth2PKCE_test.mustache", createPath("test", invokerPackage, "sdk"), "OAuth2PKCE.spec.js"));
